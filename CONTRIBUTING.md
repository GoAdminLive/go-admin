...
See [manual](https://github.com/GoAdminLive/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/GoAdminLive/go-admin clone, so:
...
Notice: `go get` return `package github.com/GoAdminLive/go-admin: no Go files in /go/src/github.com/GoAdminLive/go-admin` is normal.
