...
## Translation
We need your help: [https://github.com/GoAdminLive/docs/issues/1](https://github.com/GoAdminLive/docs/issues/1)

## Who is using

[Comment the issue to tell us](https://github.com/GoAdminLive/go-admin/issues/71).
...
- [pure golang](https://github.com/GoAdminLive/example), simple and less dependency
- [golang with frontend template](https://github.com/GoAdminLive/example_with_frontend), change template by yourself
- [golang with vue](https://github.com/GoAdminLive/example_with_vue), if you have vue experience
