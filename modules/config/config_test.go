...
func TestUpdate(t *testing.T) {
	m := map[string]string{
		...
		"plugin_file_path":                  `/go/src/github.com/GoAdminLive/go-admin/examples/gin/plugins.go`,
...
func TestToMap(t *testing.T) {
	...
	arr := []string{
		...
		"logger_rotate_max_size",
		"logger_rotate_max_backups",
		"logger_rotate_max_age",
		"logger_rotate_compress",
		"logger_encoder_time_key",
		"logger_encoder_level_key",
		"logger_encoder_name_key",
		"logger_encoder_caller_key",
		"logger_encoder_message_key",
		"logger_encoder_stacktrace_key",
		"logger_encoder_level",
		"logger_encoder_time",
		"logger_encoder_duration",
		"logger_encoder_caller",
		"logger_encoder_encoding",
		"logger_level",
		"color_scheme",
		"session_life_time",
		"asset_url",
		...
		"animation_delay",
		"no_limit_login_ip",
		"allow_del_operation_log",
		"operation_log_off",
		"hide_config_center_entrance",
		"hide_app_info_entrance",
		"hide_tool_entrance",
