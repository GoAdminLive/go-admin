...
func GetUserTable(ctx *context.Context) (userTable table.Table) {
	...
	info.AddField("Book", "name", db.Varchar).FieldJoin(
		types.Join{
			JoinField: "user_id",
			Field:     "id",
	...
	formList.AddField("Cert", "certificate", db.Varchar, form.Multifile).FieldOptionExt(
	...
	formList.AddField("Country", "country", db.Tinyint, form.SelectSingle).
		...
		).FieldDefault("china").FieldOnChooseAjax(
		"city", "/choose/country",
