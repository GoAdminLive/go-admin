...
func GetPostsTable(ctx *context.Context) (postsTable table.Table) {
	...
	info.AddField("AuthorName", "name", db.Varchar).FieldDisplay(
		func(value types.FieldModel) interface{} {
	...
	info.AddField("AuthorFirstName", "first_name", db.Varchar).FieldJoin(
		types.Join{
			Field:     "author_id",
			JoinField: "id",
			Table:     "authors",
	...
	info.AddField("AuthorLastName", "last_name", db.Varchar).FieldJoin(
		types.Join{
			Field:     "author_id",
			JoinField: "id",
			Table:     "authors",
	...
	info.AddField("AuthorCreatedAt", "created_at", db.Varchar).FieldJoin(
		types.Join{
			Field:     "author_id",
			JoinField: "id",
			Table:     "authors",
