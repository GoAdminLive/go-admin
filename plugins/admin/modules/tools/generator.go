...
import "github.com/GoAdminLive/go-admin/plugins/admin/modules/table"
...
func InsertPermissionOfTable(conn db.Connection, table string) {
	...
	InsertPermissionInfoDB(
		conn, table+" "+language.GetWithScope("query", "generator"), table+"_query", "GET", "/info/"+table,
	)
	InsertPermissionInfoDB(
		conn, table+" "+language.GetWithScope("show edit form page", "generator"), table+"_show_edit", "GET",
		"/info/"+table+"/edit",
	)
	InsertPermissionInfoDB(
		conn, table+" "+language.GetWithScope("show create form page", "generator"), table+"_show_create", "GET",
		"/info/"+table+"/new",
	)
	InsertPermissionInfoDB(
		conn, table+" "+language.GetWithScope("edit", "generator"), table+"_edit", "POST",
		"/edit/"+table,
	)
	InsertPermissionInfoDB(
		conn, table+" "+language.GetWithScope("create", "generator"), table+"_create", "POST",
		"/new/"+table,
	)
	InsertPermissionInfoDB(
		conn, table+" "+language.GetWithScope("delete", "generator"), table+"_delete", "POST",
		"/delete/"+table,
	)
	InsertPermissionInfoDB(
		conn, table+" "+language.GetWithScope("export", "generator"), table+"_export", "POST",
		"/export/"+table,
	)
}
